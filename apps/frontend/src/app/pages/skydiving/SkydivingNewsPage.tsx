        ...
        <div className="max-w-5xl mx-auto">
            ...
            {newsData.map((news) => (
              <div key={news.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <Link to={`/skydiving/nyheder/${news.id}`} className="text-blue-600 hover:text-blue-800 font-medium">
                    Læs mere
                  </Link>
                </div>
              </div>
          ...
          <div className="mt-16 bg-blue-700 text-white rounded-lg p-8 text-center">
            ...
            <div className="flex flex-col md:flex-row gap-4 max-w-lg mx-auto">
              ...
              <button className="bg-white hover:bg-gray-100 text-blue-800 font-bold py-3 px-6 rounded-lg transition-colors whitespace-nowrap">TILMELD</button>
            </div>
          </div>
        </div>
      </div>

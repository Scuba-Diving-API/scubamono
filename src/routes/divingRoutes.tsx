...
const fallbackRoutes = [
  <Route key="uddannelse" path="/uddannelse" element={<Navigate to="/diving/uddannelse" replace />} />,
  <Route key="discipliner" path="/discipliner" element={<Navigate to="/diving/discipliner" replace />} />,
  <Route key="events" path="/events" element={<Navigate to="/diving/events" replace />} />,
  <Route key="om-dsf" path="/om-dsf" element={<Navigate to="/diving/om-dsf" replace />} />,
  <Route key="webshop" path="/webshop" element={<Navigate to="/diving/webshop" replace />} />,
];

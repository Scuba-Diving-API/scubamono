  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen max-h-[600px] overflow-hidden">
        <video className="absolute inset-0 w-full h-full object-cover" autoPlay muted loop playsInline src={skydivingBgVideo} />
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center text-center">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Dansk Faldskærms Union</h1>
            <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto">Oplev friheden i frit fald – Spring med DFU</p>
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              <Link to="/skydiving/find-klub" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-full transition-colors">
                Find en klub
              </Link>
              <Link to="/skydiving/kurser" className="bg-white hover:bg-gray-100 text-blue-800 font-bold py-3 px-6 rounded-full transition-colors">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 mb-8">Dansk Faldskærms Union (DFU) er det officielle specialforbund for faldskærmsudspring i Danmark. Vi arbejder for at fremme sporten, sikre høj sikkerhed og udvikle talenter på alle niveauer.</p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-semibold text-blue-800 mb-3">For nybegyndere</h3>
                <p className="text-gray-700">Vi tilbyder uddannelse og kurser for alle, der gerne vil opleve den ultimative frihed i luften. Vores certificerede instruktører sikrer en tryg og sjov oplevelse.</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700">Faldskærmsudspring indeholder mange forskellige discipliner og områder – fra formation skydiving til freestyle og wingsuit.</p>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700">Vi støtter vores medlemsklubber med uddannelse, materialer og ressourcer for at sikre høj kvalitet og sikkerhed i hele landet.</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">Dansk Faldskærms Union inviterer til Danmarksmesterskabet i Formation Skydiving 2025, som afholdes i Odense Faldskærmsklub.</p>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">DFU's sikkerhedsudvalg har opdateret sikkerhedsreglerne for 2025-sæsonen. Alle springere skal sætte sig ind i de nye regler.</p>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">Foråret er her, og tandemspring-sæsonen er officielt åbnet! Find din nærmeste klub og book dit spring i dag.</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 text-sm mb-3">Oplev spændingen ved faldskærmsudspring fastspændt til en erfaren instruktør. Den perfekte oplevelse for nybegyndere.</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 text-sm mb-3">Konkurrencedisciplin hvor hold af springere danner formationer under frit fald. Kræver præcision og samarbejde.</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 text-sm mb-3">Flyv som en fugl med en specialdesignet dragt, der giver dig mulighed for at svæve længere og mere kontrolleret.</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 text-sm mb-3">Klassisk konkurrencedisciplin hvor målet er at lande så præcist som muligt på et markeret målområde.</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              ...
              <button className="bg-white hover:bg-gray-100 text-blue-800 font-bold py-3 px-6 rounded-lg transition-colors">TILMELD</button>
            </div>
          </div>
        </div>
      </section>
